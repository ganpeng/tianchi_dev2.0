    ...
    <div class="live-channel-container">
        ...
        <div class="tabel-field">
            ...
            <el-table header-row-class-name="common-table-header" class="my-table-style" :data="list" border>
                ...
                <el-table-column prop="no" align="center" width="140px" label="展示编号"></el-table-column>
                ...
                <el-table-column prop="pushServer" align="center" width="120px" label="所属服务器"></el-table-column>
                <el-table-column align="center" width="130px" label="是否录制回看">
                    <template slot-scope="scope">
